							...
							<tr>
								...
								<td>
									<div
										...
										<a class="btn btn-xs btn-info" data-rel="tooltip" data-placement="bottom" title="取消报名" href="<utils:url url="#" />">
									...
									<div class="visible-xs visible-sm hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul
												...
												<li><a href="<utils:url url="#" />" class="tooltip-success"
													data-rel="tooltip" title="取消报名"> <span class="blue">
					...
					<div class="row">
						...
						<div class="btn-group dropup">
							...
							<ul class="dropdown-menu">
								<li><a href="<utils:url url="#" />">批量取消</a></li>
