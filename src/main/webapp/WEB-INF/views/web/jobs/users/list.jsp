			...
			<form action="" class="isst-table-form">		
				<table class="table table-striped table-bordered table-hover">
									...
									<div class="visible-xs visible-sm hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul
												...
												<li>
													<a href="<utils:url url="/jobs/${job.id}/comments.html" returned="true"/>" class="tooltip-success" data-rel="tooltip" title="Comments"> 
														<span class="green">
															<i class="icon-comments bigger-120"></i> 
														</span> 
													</a>
												...
												<li><a href="<utils:url url="/users/jobss/categories/${category.alias}/delete?id[]=${job.id}" />" class="tooltip-error"
					...
					<div class="col-xs-12 col-sm-4 isst-table-form-actions">
						<a href="<utils:url url="/users/jobss/categories/${category.alias}/delete" />" class="btn btn-primary">批量删除</a>
					</div>
