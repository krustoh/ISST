					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								<td class="center">
								<label>
								<input type="checkbox" class="ace" name="id[]" value="${message.id}"/> <span class="lbl"></span> </label>
								</td>
								<td>${message.id}</td>
								<td>
									${message.title}
								...
								<td>
									<div
										...
										<a class="btn btn-xs btn-danger" data-rel="tooltip" data-placement="bottom" title="删除" href="<utils:url url="/messages/delete?id[]=${message.id}" />">
									...
									<div class="visible-xs visible-sm hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul
												...
												<li><a href="<utils:url url="/messages/delete?id[]=${message.id}" />" class="tooltip-error"
					...
					<div class="col-xs-12 col-sm-4 isst-table-form-actions">
						...
						<div class="col-sm-8 col-xs-12">
							...
							<div id="pager" class="pull-right">
								<pagination:paging page="${messages.page}" total="${messages.total}" size="${messages.pageSize}" />
							</div>
							<!-- end pager -->
						</div>
					</div>
